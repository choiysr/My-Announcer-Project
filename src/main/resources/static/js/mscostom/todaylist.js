 ...
 function appendlist(list) {
    ...
    list.content.forEach(list => {
       ...
       str +=
          ...
          '<td  style="padding-top: 40px;">' + '<a href="#"><i class="far fa-play-circle playBtn" style="font-size:30px" data-time = "' + time + '"></a></i>' + '</td>' +
          '<td class="test" style="padding-top: 25px; padding-left: 5px; padding-right: 5px; height:70px;">' +
          '<audio style=" width: 35vw; min-width: 1cm; display:none;" id="audio' + time + '" controls class="playerInList" data-alarmBell="' + list.audioVO.alarmBell + '" source id="sourcelink" src="http://localhost:8080/rbcboard/' + wholePathOfFile + '"> </audio>' +
 ...
 vals.$listdiv.on('click', '.playBtn', function (e) {
    ...
    console.log(audio.attr("data-alarmBell"));
